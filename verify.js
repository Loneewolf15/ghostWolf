...
const handlerPos = src.indexOf("ghostwolf.on('stt:interim'");
...
const finalHandlerPos = src.indexOf("ghostwolf.on('stt:final'");
...
const llmStartIdx = src.indexOf("ghostwolf.on('llm:start'");
const llmTokenIdx = src.indexOf("ghostwolf.on('llm:token'");
