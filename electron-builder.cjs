...
module.exports = {
  ...
  mac: {
    ...
    extendInfo: {
      ...
      NSMicrophoneUsageDescription:
        "ghostwolf transcribes your microphone so it can help you in conversations.",
      NSCameraUsageDescription: "ghostwolf does not use the camera.",
      NSAudioCaptureUsageDescription:
        "ghostwolf captures system audio to transcribe the other participant in a call.",
    },
  },
  win: {
  ...
  // A per-user install with a visible directory step: ghostwolf is a personal overlay,
